...
function love.load()
    ...
    G.laneTouchZones = {
        { x = 0, y = 105, w = 900, h = 90 }, -- lane 1
        { x = 0, y = 205, w = 900, h = 90 }, -- lane 2
        { x = 0, y = 305, w = 900, h = 90 }, -- lane 3
        { x = 0, y = 400, w = 900, h = 120 }   -- lane 4
    }

    -- Debug visual de zonas táctiles. Ponlo en false cuando ya esté bien.
    G.showTouchDebug = true

    G.serveButton = { x = 720, y = 500, w = 140, h = 70, label = "SERVE" }
